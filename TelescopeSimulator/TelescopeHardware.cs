...
namespace ASCOM.Simulators
{
    public static class TelescopeHardware
    {
        ...
        // Slew no-progress guard (rusty-photon #319). Tracks per-tick slew
        // progress so a slew that can make no headway — e.g. CheckAxisLimits
        ...
        private static void MoveAxes()
        {
            ...
            // No-progress guard (rusty-photon #319). If DoSlew did not finish the
        ...
        private static Vector DoSlew()
        {
            ...
            // rusty-photon #319: the shortest-path rotation above can drive the
            // primary axis through the GEM hour-angle limit (CheckAxisLimits then
